...
export const PANEL_ACCESS_RESOURCES: AccessResource[] = [
  ...
  { resourceKey: "panel:commercial.claims.registration", label: "Reclamos / Registro",     section: "Paneles" },
  { resourceKey: "panel:commercial.claims.approval",     label: "Reclamos / Aprobaciones", section: "Paneles" },
  { resourceKey: "panel:commercial.claims.application",  label: "Reclamos / Aplicaciones", section: "Paneles" },
...
const API_ACCESS_RULES_UNSORTED: ApiAccessRule[] = [
  ...
  {
    pathnamePrefix: "/api/talento-humano/simulador-vacaciones",
    policy: "resource-bound",
