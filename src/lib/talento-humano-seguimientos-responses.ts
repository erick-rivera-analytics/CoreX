  ...
  return withHumanTalentTransaction(async (client) => {
    ...
    await client.query(
      ...
      INSERT INTO public.tthh_fact_employee_followup_response_cur (
        ...
        induction_sufficient_code, transport_problem_code,
      ...
      [
        ...
        input.workDifficultyObservation ?? null,
        ...
        input.inductionSufficientCode ?? null, input.transportProblemCode ?? null,
