...
export const MODULE_CATALOG: CatalogModule[] = [
  ...
  {
    key: "postcosecha-productividad",
    label: "Productividad",
    title: "Productividad",
    eyebrow: "Analítica / Postcosecha / Indicadores & KPI",
    summary: "Horas trabajadas por caja 10kg desde fecha_post, camino, destino y área de postcosecha.",
    href: "/dashboard/postcosecha/productividad",
    icon: Clock,
    navigationGroup: "Dashboard",
    trail: ["Postcosecha", "Indicadores & KPI"],
    accessSection: "Analítica / Indicadores & KPI",
